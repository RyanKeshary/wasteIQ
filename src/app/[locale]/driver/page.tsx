  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div
        ...
        className="mb-8"
      >
        <Link href="/driver/messages?chat=2" className="no-underline">
          <div 
          ...
          >
            <div className="flex items-center gap-4 relative z-10">
              <div className="w-12 h-12 rounded-full bg-white/20 flex items-center justify-center relative">
                ...
                <span className="absolute -top-1 -right-1 w-4 h-4 bg-error rounded-full border-2 border-secondary animate-pulse" />
              </div>
              <div>
                <p className="text-[10px] font-bold uppercase tracking-widest opacity-80">Citizen Waiting</p>
                <h3 className="title-md text-white m-0">Rajesh Sharma</h3>
                <p className="text-xs opacity-70">"I am waiting at the corner of Market Lane"</p>
              </div>
            </div>
            <button 
